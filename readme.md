...
2. Open the app.R file in an editor and add your aws credentials by replacing the 
	#es in line 7 and 8 with your aws_access_key_id and aws_access_secret_key 
